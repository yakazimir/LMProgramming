...
[**lecture 5**](https://github.com/yakazimir/LMProgramming/blob/main/slides/lecture5.pdf): Advanced prompting, [**chain-of-thought**](https://proceedings.neurips.cc/paper/2022/hash/9d5609613524ecf4f15af0f7b31abca4-Abstract-Conference.html), [**imperative model programming**](https://arxiv.org/pdf/2212.06094), ([discrete](https://arxiv.org/abs/1904.02079)) [**probabilistic programming**](https://discovery.ucl.ac.uk/id/eprint/10089698/1/main.pdf). [[**language implementatio notes**](https://github.com/yakazimir/LMProgramming/blob/main/slides/implementation.pdf)]
...
**extra lectures** [Prompting as programming](https://github.com/yakazimir/LMProgramming/blob/main/slides/prompting_programming.pdf), [Grammar-constrained decoding](https://github.com/yakazimir/LMProgramming/blob/main/slides/grammar_decoding.pdf), [Implementing languages in Python](https://github.com/yakazimir/LMProgramming/blob/main/slides/implementation.pdf)
...
- **automated reasoning tools/circuits** [[Z3 solver]](https://github.com/Z3Prover/z3), [[python-sat]](https://pysathq.github.io/), [[pysdd]](https://github.com/wannesm/PySDD), [[cirkit](https://github.com/april-tools/cirkit)] 
- **NLP and general ML** [[transformers]](https://github.com/huggingface/transformers), [[PyTorch]](https://pytorch.org/), [[pylon-lib]](https://github.com/pylon-lib/pylon), [[hf datasets]](https://huggingface.co/docs/datasets/index), [[hf hub]](https://huggingface.co/docs/hub/en/index)
